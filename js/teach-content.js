  ...
  science: {
    biology: {
      ...
      practice: [
        ...
        {
          q: "Which gas do plants release in photosynthesis?",
          type: "multi",
          options: ["Carbon dioxide", "Nitrogen", "Oxygen", "Helium"],
          answer: 2,
          explain: "Oxygen is released; CO₂ is taken in.",
        },
        {
          q: "Blood is carried away from the heart in…",
          type: "multi",
          options: ["Veins only", "Arteries", "Hair", "Bone marrow only"],
          answer: 1,
          explain: "Arteries carry blood away from the heart.",
        },
        {
          q: "Cells are the…",
          type: "multi",
          options: ["largest organs", "basic units of life", "only found in plants", "same as atoms"],
          answer: 1,
          explain: "Cells are the basic building blocks of living things.",
        },
        {
          q: "A vaccine helps the body…",
          type: "multi",
          options: ["digest food faster", "recognise and fight a pathogen", "grow taller overnight", "stop needing water"],
          answer: 1,
          explain: "Vaccines train the immune system.",
        },
        {
          q: "Which organ system includes the heart and blood vessels?",
          type: "multi",
          options: ["Digestive", "Circulatory", "Skeletal", "Nervous"],
          answer: 1,
          explain: "Circulatory system moves blood around the body.",
        },
      ],
      struggle: {
        points: [
        ...
        practice: [
          ...
          },
          {
            ...
            type: "multi",
            options: ["Pump blood", "Make bone", "Filter air only"],
            answer: 0,
            explain: "It pumps blood around the body.",
          },
          {
            q: "Green plants need sunlight mainly to…",
            type: "multi",
            options: ["Make food", "Sleep", "Attract magnets"],
            answer: 0,
            explain: "Sunlight powers photosynthesis.",
          },
        ],
      },
    },
    chemistry: {
      ...
      practice: [
        ...
        {
          q: "Particles in a gas are…",
          type: "multi",
          options: ["Locked in place", "Far apart and free to move", "Always frozen solid"],
          answer: 1,
          explain: "Gas particles move freely and fill the space.",
        },
        {
          q: "Burning wood is mainly a…",
          type: "multi",
          options: ["Physical change", "Chemical change", "Change of colour only with no new substance"],
          answer: 1,
          explain: "New substances form (ash, gases) — chemical.",
        },
        {
          q: "Salt dissolved in water can be recovered by…",
          type: "multi",
          options: ["Evaporation", "Using a magnet", "Filtering with dry paper only once"],
          answer: 0,
          explain: "Evaporate the water; salt remains.",
        },
        {
          ...
          answer: 1,
          explain: "Liquids flow and keep volume.",
        },
        {
          q: "Rust forming on iron is…",
          type: "multi",
          options: ["A physical change", "A chemical change", "Just dirt sitting on top"],
          answer: 1,
          explain: "A new substance (rust) is made.",
        },
      ],
      struggle: {
        points: [
        ...
        practice: [
          ...
          },
          {
            q: "Ice melting makes…",
            type: "multi",
            options: ["A new chemical", "Liquid water (same substance)", "Oxygen gas only"],
            answer: 1,
            explain: "Still H₂O — physical change.",
          },
          {
            q: "A solid has a…",
            type: "multi",
            options: ["Fixed shape", "No volume", "Shape that always fills the room"],
            answer: 0,
    ...
    physics: {
      ...
      practice: [
        ...
        {
          q: "A complete loop for electricity is called a…",
          type: "multi",
          options: ["Circuit", "Magnet", "Shadow", "Prism"],
          answer: 0,
          explain: "A circuit lets current flow in a loop.",
        },
        {
          q: "Which force slows a bike when you brake?",
          type: "multi",
          options: ["Gravity only", "Friction", "Magnetism from the Moon"],
          answer: 1,
          explain: "Brake pads use friction.",
        },
        {
          q: "Energy from food is stored as…",
          type: "multi",
          options: ["Chemical energy", "Sound energy only", "Nuclear energy in your shoes"],
          answer: 0,
          explain: "Food stores chemical energy.",
        },
        {
          q: "In a series circuit, one bulb failing usually…",
          type: "multi",
          options: ["Keeps all other bulbs on", "Turns the whole loop off", "Makes sound louder"],
          answer: 1,
          explain: "Series = one path; a break stops the circuit.",
        },
        {
          q: "A bouncing ball shows energy being…",
          type: "multi",
          options: ["Created from nothing", "Transferred between stores", "Deleted forever"],
          answer: 1,
          explain: "Energy transfers (e.g. kinetic ↔ gravitational).",
        },
      ],
      struggle: {
        points: [
        ...
        practice: [
          ...
          {
            q: "Gravity pulls objects…",
            type: "multi",
            options: ["Toward Earth", "Only sideways", "Into space always"],
            answer: 0,
            explain: "Gravity pulls toward Earth.",
          },
          {
            q: "Sound needs particles to…",
            type: "multi",
            options: ["Vibrate", "Disappear", "Turn into light only"],
            answer: 0,
            explain: "Vibrating particles carry sound.",
          },
        ],
      },
    },
