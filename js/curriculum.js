...
const SKILLS = {
  maths: {
    number: { name: "Counting & numbers", gcse: "Number" },
    operations: { name: "Add, take away, times", gcse: "Number" },
    fractions: { name: "Halves & quarters", gcse: "Ratio & proportion" },
    algebra: { name: "Missing numbers", gcse: "Algebra" },
    geometry: { name: "Shapes", gcse: "Geometry" },
    data: { name: "Sorting & pictograms", gcse: "Statistics" },
  },
  english: {
  ...
  maths: [
    {
      ...
      options: ["4", "9", "2", "7"],
      answer: 1,
      explain: "9 is the biggest of these numbers.",
    },
    {
      id: "m2",
      skill: "number",
      stage: "both",
      q: "What number comes after 8?",
      type: "typed",
      answer: "9",
      explain: "Count on: 8, then 9.",
    },
    {
      id: "m3",
      skill: "operations",
    ...
    },
    {
      ...
      options: ["2", "3", "4", "6"],
      answer: 2,
      explain: "Half means split into 2 equal parts. 8 ÷ 2 = 4.",
    },
    {
      id: "m8",
      skill: "fractions",
      stage: "ks3",
      q: "What is a quarter of 12?",
      type: "typed",
      answer: "3",
      explain: "A quarter is 1 of 4 equal parts. 12 ÷ 4 = 3.",
    },
    {
      id: "m9",
      skill: "algebra",
      stage: "both",
      q: "3 + □ = 7. What is the missing number?",
      type: "typed",
      answer: "4",
      explain: "3 and 4 make 7.",
    },
    {
      id: "m10",
      skill: "algebra",
      stage: "ks3",
      q: "10 − □ = 6. What is the missing number?",
      type: "typed",
      answer: "4",
      explain: "10 take away 4 is 6.",
    },
    {
      id: "m11",
      skill: "geometry",
    ...
    },
    {
      ...
      skill: "geometry",
      stage: "both",
      q: "A triangle has how many corners?",
      type: "typed",
      answer: "3",
      explain: "A triangle has 3 corners (and 3 sides).",
    },
    {
      id: "m13",
      skill: "data",
      stage: "both",
      q: "Which group has more: 2 apples or 5 apples?",
      type: "multi",
      options: ["2 apples", "5 apples", "They are the same"],
      answer: 1,
      explain: "5 is more than 2.",
    },
  ],
  english: [
    {
    ...
    },
    {
      ...
      skill: "punctuation",
      stage: "both",
      q: "Which sentence has a full stop at the end?",
      type: "multi",
      options: ["The cat sat", "The cat sat.", "The cat sat?", "the cat sat"],
      answer: 1,
      explain: "A telling sentence ends with a full stop: The cat sat.",
    },
    {
      id: "e4",
      skill: "punctuation",
      ...
      type: "multi",
      options: ["becos", "because", "becuz", "becouse"],
      answer: 1,
      explain: "because — a useful word to learn by heart.",
    },
    {
      id: "e5",
      skill: "vocabulary",
...
const LESSONS = {
  maths: {
    number: {
      ...
      blurb: "Count, compare and write numbers — the very first step.",
      items: [
        {
          q: "What number comes after 5?",
          type: "typed",
          answer: "6",
          explain: "Count: 5, then 6.",
        },
        {
          q: "Which is smaller?",
          type: "multi",
          options: ["8", "3", "9", "6"],
          answer: 1,
          explain: "3 is the smallest.",
        },
        {
          q: "How many tens in 20?",
          type: "typed",
          answer: "2",
          explain: "20 is 2 tens.",
        },
      ],
    },
    operations: {
      title: "Add, take away, times",
      blurb: "Small sums you can do on your fingers if you need to.",
      items: [
        {
          q: "What is 2 + 5?",
          type: "typed",
          answer: "7",
          explain: "2 and 5 more is 7.",
        },
        {
          q: "What is 9 − 1?",
          type: "typed",
          answer: "8",
          explain: "Take 1 from 9 → 8.",
        },
        {
          q: "What is 5 × 2?",
          type: "multi",
          options: ["7", "10", "12", "52"],
          answer: 1,
          explain: "Five 2s, or the 2-times table: 10.",
        },
      ],
    },
    fractions: {
      title: "Halves & quarters",
      blurb: "Sharing into 2 or 4 equal parts.",
      items: [
        {
          q: "What is half of 6?",
          type: "typed",
          answer: "3",
          explain: "6 split into 2 equal groups is 3.",
        },
        {
          q: "Which picture is a half? (think of a pizza)",
          type: "multi",
          options: ["1 of 4 slices", "2 of 4 slices", "3 of 4 slices", "the whole pizza"],
          answer: 1,
          explain: "2 of 4 slices is the same as half.",
        },
        {
          q: "What is a quarter of 8?",
          type: "typed",
          answer: "2",
          explain: "8 ÷ 4 = 2.",
        },
    ...
    algebra: {
      ...
      blurb: "Find the number that belongs in the box. Not GCSE algebra yet.",
      items: [
        {
          q: "4 + □ = 6. What is □?",
          type: "typed",
          answer: "2",
          explain: "4 and 2 make 6.",
        },
        {
          q: "□ − 3 = 5. What is □?",
          type: "typed",
          answer: "8",
          explain: "8 take away 3 is 5.",
        },
        {
          q: "2 + 2 + □ = 6. What is □?",
          type: "multi",
          options: ["1", "2", "3", "4"],
          answer: 1,
          explain: "2 + 2 is 4, and 2 more makes 6.",
        },
      ],
    },
    geometry: {
      ...
      items: [
        ...
        },
        {
          q: "A circle is…",
          type: "multi",
          options: ["a round shape", "a shape with 4 sides", "a cube", "a line"],
          answer: 0,
          explain: "A circle is round, like a wheel.",
        },
        {
          q: "How many sides does a rectangle have?",
          type: "typed",
          answer: "4",
          explain: "A rectangle has 4 sides.",
        },
      ],
    },
    data: {
      title: "Sorting & pictograms",
      blurb: "More, less, and simple pictures of data.",
      items: [
        {
          q: "Which is more: 3 or 8?",
          type: "multi",
          options: ["3", "8", "the same"],
          answer: 1,
          explain: "8 is more than 3.",
        },
        {
          q: "A tally of |||| means…",
          type: "typed",
          answer: "4",
          explain: "Four marks = 4.",
        },
        {
          q: "If 2 children like cats and 5 like dogs, which is more popular?",
          type: "multi",
          options: ["cats", "dogs", "the same"],
          answer: 1,
          explain: "5 is more than 2, so dogs.",
        },
      ],
    },
  },
...
const BADGES = [
  ...
  { id: "weekly_goal", name: "Weekly Goal", emoji: "📅", desc: "Hit this week's activity goal" },
  { id: "monthly_goal", name: "Monthly Goal", emoji: "🌙", desc: "Hit this month's activity goal" },
  { id: "goal_triple", name: "Triple Goal", emoji: "🎯", desc: "Hit daily, weekly and monthly goals at once" },
